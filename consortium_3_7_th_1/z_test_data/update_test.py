...
import sys
sys.path.append('../')
from transaction_file.transaction_args import invoke_create_args, invoke_update_args



from config.config import NODE_INFO, NODE, TEST_KEY
...
def update_test(contract_addr, t, i):
    ip = '127.0.0.1:1234'
    to = contract_addr
...
if __name__ == '__main__':
    ...
    for i in range(0, 50):
        ...
        update_test(contract_addr,  root, i)
        pack_block()
